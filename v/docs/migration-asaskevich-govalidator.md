...
| Feature    | govalidator                 | v                                         |
| :--------- | :-------------------------- | :---------------------------------------- |
| **Email**  | `govalidator.IsEmail(str)`  | `v.Text().Email().Validate(str)`          |
| **URL**    | `govalidator.IsURL(str)`    | `v.Text().URL().Validate(str)`            |
| **UUID**   | `govalidator.IsUUID(str)`   | `v.Text().UUID().Validate(str)`           |
| **Int**    | `govalidator.IsInt(str)`    | `v.Text().Numeric().Validate(str)`        |
| **Base64** | `govalidator.IsBase64(str)` | `v.Text().Base64().Validate(str)`         |
